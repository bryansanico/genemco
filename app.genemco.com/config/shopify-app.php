...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_themes,write_themes,write_script_tags, write_orders,read_orders,write_draft_orders,read_customers,write_customers'),
    ...
    */
    ...
    'after_authenticate_job' => [
            [
                'job' => '\App\Jobs\AfterAuthenticateJob',
                'inline' => false // False = dispatch job for later, true = dispatch immediately
            ],
    ],
